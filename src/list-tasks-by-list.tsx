...
export default function ListTasksByListCommand() {
    ...
    async function loadTodosForList(list: TaskList) {
        ...
        const toast = await showToast({
            ...
            title: `Loading tasks for ${list.displayName}...`,
        })
        try {
                    ...
                    <List.EmptyView
                        ...
                        description={
                            currentFilter === "all"
                                ...
                                : `No tasks match the "${currentFilter === "with-due-date" ? "With Due Date" : "Important"}" filter`
                        }
                        icon={Icon.Checkmark}
                    />
                ) : (
                                    ...
                                    actions={
                                        <ActionPanel>
                                            <Action
                                                ...
                                                onAction={() => handleMarkAsComplete(todo.id)}
                                            />
                                            <Action.CopyToClipboard content={todo.title} title="Copy Task Title" />
                            ...
                            actions={
                                <ActionPanel>
                                    <Action
                                        ...
                                        onAction={() => loadTodosForList(list)}
                                    />
                                    <Action.OpenInBrowser title="Open in to Do" url="https://to-do.live.com" />
                                    <Action
                                        title="Reload"
